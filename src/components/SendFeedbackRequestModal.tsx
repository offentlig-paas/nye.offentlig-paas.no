            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                  <p>
                    Du kjører i utviklingsmodus. Meldinger som inneholder
                    localhost-URLer vil bli blokkert med mindre du aktiverer
                    testmodus eller setter NEXT_PUBLIC_URL til produksjon.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700 dark:text-blue-400">
                  <p>
                    Forespørselen vil bli sendt som en privat melding på Slack
                    til alle påmeldte med status &quot;Deltok&quot; som ikke
                    allerede har gitt tilbakemelding. Meldingen inkluderer en
                    lenke til tilbakemeldingsskjemaet.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div>
          ...
          <div className="mt-2 space-y-1">
            <p className="text-xs text-zinc-500 dark:text-zinc-400">
              Be deltakerne om å gi tilbakemelding på arrangementet. Meldingen
              vil sendes som en formatert melding på Slack med lenke til
              tilbakemeldingsskjemaet.
            </p>
            <p className="text-xs text-zinc-600 dark:text-zinc-300">
              <span className="font-medium">Inkludert automatisk:</span>{' '}
              Arrangementsnavn, dato og lenke til tilbakemeldingsskjema.
            </p>
          </div>
        </div>
