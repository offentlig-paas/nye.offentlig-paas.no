...
export const ContainerOuter = forwardRef<ElementRef<'div'>, OuterContainerProps>(
...
export const ContainerInner = forwardRef<React.ElementRef<'div'>, ContainerInnerProps>(
