...
export const events: Event[] = [
  {
    ...
    ingress:
      'Vi inviterer til fagdag mandag 25. mai (NB! NY DATO) fra kl 12:00 - 16:00 i Forskningsparken / Oslo. Foreløpig har vi bare satt av tid og auditorium, men håper på godt engasjement og oppmøte.',
    description:
    ...
    start: new Date('2026-05-25T12:00+01:00'),
