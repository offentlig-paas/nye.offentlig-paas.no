...
import { EventParticipantInfoProvider } from '@/contexts/EventParticipantInfoContext'
...
export default async function Fagdag({ params }: { params: Params }) {
  ...
  return (
    <EventRegistrationProvider eventSlug={slug}>
      <EventParticipantInfoProvider eventSlug={slug}>
          ...
          <div className="mx-auto max-w-7xl py-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 grid-rows-1 items-start gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              ...
              <div className="-mx-4 px-6 py-6 shadow-sm ring-1 ring-gray-900/5 sm:mx-0 sm:rounded-lg lg:col-span-2 lg:row-span-2 lg:row-end-2 dark:ring-gray-400/5">
                ...
                <h2 className="mt-8 text-base leading-6 font-semibold">
                  Agenda
                </h2>
